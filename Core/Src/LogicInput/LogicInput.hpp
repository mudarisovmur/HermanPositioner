...
class LogicInput : public ILogicInput, 
   ...
   * @param pin - пин gpio
   */
  void registerInput(GPIO_TypeDef* port, uint16_t pin);
  ...
  static const uint16_t          ACTIVATION_TIME = 2;
  
  /// Количество тиков до длительной активации
  static const uint16_t          LONG_ACTIVATION_TIME = 500;
  
  /// Количество тиков до снятия активации
  static const uint16_t          RESET_TIME = 2;
};
